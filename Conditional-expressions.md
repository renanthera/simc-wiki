...
* _equipped_._`<`item_id`>`_ or _equipped_._`<`item_name`>`_ or _equipped_._`<`on_use_effect`>`_ evaluates to true if the player has equipped the specified item or an item with the specified on-use effect.
