...
#### 8.2 Rise of Azshara options
  ...
  * **bfa.shiver_venom** (scope: global; default true) Specify whether items that rely on the Shiver Venom debuff from Shiver Venom Relic should assume the debuff is present. Applies to Shiver Venom Crossbow and Shiver Venom Lance.
