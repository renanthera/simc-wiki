...
* **dragonflight.undulating_sporecloak_update_interval** (scope: global; default: 5s) Controls how often the sim rolls for Undulating Sporecloak uptime. This interval is subject to a gaussian distribution.
* **dragonflight.undulating_sprecloak_update_interval_stddev** (scope: global; default: 2.5s) Standard deviation of undulating_sporecloak_update_interval.
