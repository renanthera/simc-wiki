...
#### 8.2 Rise of Azshara options
  ...
  * **bfa.font_of_power_precombat_channel** (scope: global; default _disabled_) This option will set, in seconds, how many seconds before combat start you will begin channeling the trinket Azshara's Font of Power. For example, if you set `bfa.font_of_power_precombat_channel=4` you will be considered to have begun channeling 4s before combat start, and will enter combat with the full 30s buff, the trinket on 116s cooldown, and shared trinket cooldown of 16s. Accepts values from 0 to 34.
