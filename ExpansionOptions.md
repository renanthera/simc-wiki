...
You can use the option **bfa.loyal_to_the_end_ally_death_Timer** (scope: global; default 60; minimum 1) to set the frequency in seconds in which the check is made.
