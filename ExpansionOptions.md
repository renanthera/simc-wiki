 ...
 * **shadowlands.volatiles_solvent_type** (scope: global; default: none) The type of corpse/buff you've consumed for the Volatile Solvent soulbind. Valid types are:
